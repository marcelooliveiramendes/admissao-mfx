            ...
            <div className='container'>
                ...
                <form action="" id='formularioDadosPessoais'>
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-1">Sexo</InputLabel>
                        <Select
                    ...
                    <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-2">Raça</InputLabel>
                        <Select
                        ...
                        >
                            <MenuItem value={'Branco(a)'}>Branco(a)</MenuItem>
                            <MenuItem value={'Pardo(a)'}>Pardo(a)</MenuItem>
                            <MenuItem value={'Preto(a)'}>Preto(a)</MenuItem>
                            <MenuItem value={'Amarelo(a)'}>Amarelo(a)</MenuItem>
                            <MenuItem value={'Indígena'}>Indígena</MenuItem>
                        </Select>
                    </FormControl>
                    <FormControl fullWidth>
                        <InputLabel id="demo-simple-select-3">Estado Civil</InputLabel>
                        <Select
                            labelId="demo-simple-select-3"
                            id="slc_estadoCivil"
                            label="Estado Civil"
                            value={estadoCivil}
                    ...
                    {nascExterior &&(
                      <motion.div 
                        ...
                        exit={{opacity: 0}}
                        transition={{ ease: "easeOut", duration: 1 }}
                      className="formNascExterior">
                        <Autocomplete
                          freeSolo
                            id={'ztxt_paisNacionalidade'}
                            options={countries}
                            defaultValue={nacionalidadeNascExt}
                            renderOption={(props, option) => (
                              <Box component="li" sx={{ '& > img': { mr: 2, flexShrink: 0 } }} {...props}>
                                <img
                                  loading="lazy"
                        ...
                        <Autocomplete
                          ...
                          renderInput={(params) => <TextField {...params} label={"Estado (naturalidade)"} />}
                        />
